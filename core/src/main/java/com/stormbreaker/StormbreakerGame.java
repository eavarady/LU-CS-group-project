...
public class StormbreakerGame extends Game {
    ...
    public void create() {
        ...
        levelConfigs.add(new LevelConfig(
            "maps/map_desert.tmx",
            new Vector2(100, 10), //spawn
            new Array<>(new LevelConfig.EnemySpawn[]{
                new LevelConfig.EnemySpawn(240, 32, Enemy.EnemyType.AGGRESSIVE),
                new LevelConfig.EnemySpawn(288, 48, Enemy.EnemyType.PASSIVE),
                new LevelConfig.EnemySpawn(48, 272, Enemy.EnemyType.AGGRESSIVE),
                new LevelConfig.EnemySpawn(304, 304, Enemy.EnemyType.BOMBER),
                new LevelConfig.EnemySpawn(416, 304, Enemy.EnemyType.PASSIVE),
                new LevelConfig.EnemySpawn(416, 240, Enemy.EnemyType.BOMBER),
                new LevelConfig.EnemySpawn(560, 224, Enemy.EnemyType.AGGRESSIVE),
                new LevelConfig.EnemySpawn(464, 64, Enemy.EnemyType.PASSIVE),
                new LevelConfig.EnemySpawn(608, 96, Enemy.EnemyType.AGGRESSIVE),
        ...
        levelConfigs.add(new LevelConfig(
            ...
            new Array<>(new LevelConfig.EnemySpawn[]{
                ...
                new LevelConfig.EnemySpawn(128, 224, Enemy.EnemyType.PASSIVE), // (4,17)
                new LevelConfig.EnemySpawn(384, 320, Enemy.EnemyType.AGGRESSIVE), // (12,14)
                new LevelConfig.EnemySpawn(576, 256, Enemy.EnemyType.BOMBER), // (18,16)
                new LevelConfig.EnemySpawn(1184, 672, Enemy.EnemyType.AGGRESSIVE), // (37,3)
                new LevelConfig.EnemySpawn(1120, 448, Enemy.EnemyType.AGGRESSIVE), // (35,10)
                new LevelConfig.EnemySpawn(1088, 160, Enemy.EnemyType.PASSIVE), // (34,19)
                ...
                new LevelConfig.EnemySpawn(96, 640, Enemy.EnemyType.BOMBER), // (3,4)
                new LevelConfig.EnemySpawn(96, 576, Enemy.EnemyType.PASSIVE), // (3,6)
                new LevelConfig.EnemySpawn(192, 608, Enemy.EnemyType.AGGRESSIVE), // (6,5)
                new LevelConfig.EnemySpawn(160, 640, Enemy.EnemyType.PASSIVE), // (5,4)
                new LevelConfig.EnemySpawn(224, 608, Enemy.EnemyType.AGGRESSIVE), // (7,5)
